package com.example.sandeep.javaexosia.UserSection.Registraction;
...
import com.example.sandeep.javaexosia.Admin.PersonDataCollection;
...
public class Registration_form extends AppCompatActivity {
    ...
    ArrayAdapter<String> panAdaptor;
    Uri imageUri;
    Spinner spin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("User_Verification_Table");
...
//
    ...
    private void getPanchayat(String value) {
        Query query=databaseReference.orderByChild("district").equalTo(value);
