package com.example.sandeep.javaexosia.Employee;
...
import com.example.sandeep.javaexosia.Admin.viewpageAdaptorMain;
import com.example.sandeep.javaexosia.Admin.viewpageUserAdapter;
import com.example.sandeep.javaexosia.Admin.viewpageofficeAdapter;
...
public class EmployeeMainPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       tabLayout.setupWithViewPager(viewPager);
        ...
        viewpageofficeAdapter.AddFragment(new FragmentStaffView(authority,authority_Place,"officer",Uniqname), "view Office Staff");
