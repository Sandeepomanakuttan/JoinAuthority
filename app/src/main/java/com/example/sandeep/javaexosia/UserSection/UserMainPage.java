package com.example.sandeep.javaexosia.UserSection;
...
import com.example.sandeep.javaexosia.Admin.viewpageCertificateAdaptor;
...
import com.example.sandeep.javaexosia.UserSection.Fragments.FragmentViewCertificateUser;
import com.example.sandeep.javaexosia.UserSection.Fragments.FragmentViewScheme;
...
public class UserMainPage extends AppCompatActivity {
    ...
    private void updateData(ProfileData profileData) {
        ...
        profileref.child(profileData.getUserName()).updateChildren(update).addOnSuccessListener((OnSuccessListener) this::onSuccess).addOnFailureListener(e -> {
