...
import com.example.sandeep.javaexosia.Admin.RecycleAdaptor.RequestSchemeViewAdaptor;
...
public class FragmentSchemeApprove extends Fragment {
    ...
    ArrayList< com.example.sandeep.javaexosia.UserSection.Collectionclass.PersonSchemeCollection > PersonSchemeCollection;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @org.jetbrains.annotations.NotNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    com.example.sandeep.javaexosia.UserSection.Collectionclass.PersonSchemeCollection collection = dataSnapshot.getValue(PersonSchemeCollection.class);
